...
if [ ! -f ".env" ]; then
    ...
    echo "3. Configure AWS credentials (see options below)"
    echo ""
else
...
echo "  aws sts get-caller-identity --profile devaccount"
echo ""
echo "  # Or create a new profile for this project:"
echo "  aws configure --profile twilio-relay"
echo "  # Then set AWS_PROFILE=twilio-relay in your .env file"
echo ""
...
echo ""
echo "Option 3: Edit .env file"
echo "  # Set AWS_PROFILE to your preferred profile name in .env"
echo "  # Example: AWS_PROFILE=devaccount"
echo ""
...
echo "3. Run: python -m uvicorn src.main:app --reload --port 8000"
